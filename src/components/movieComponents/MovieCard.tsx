...
export const MovieCategory = ({ 
  ...
  return (
    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between w-full mt-8 md:mt-13 h-auto md:h-9 gap-4 sm:gap-0">
      ...
      <button 
        onClick={onSeeMore}
        className="flex items-center justify-center w-full sm:w-[166px] h-full border-none rounded-2xl p-2 cursor-pointer bg-gray-100 hover:bg-gray-200 transition-colors"
      >
